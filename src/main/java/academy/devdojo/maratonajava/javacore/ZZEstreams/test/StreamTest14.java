...
public class StreamTest14 {
    ...
    public static void main(String[] args) {
        ...
        Map<Category, LightNovel> collect2 = lightNovels.stream().collect(groupingBy(LightNovel::getCategory, Collectors.collectingAndThen(maxBy(Comparator.comparing(LightNovel::getPrice)), Optional::get)));
